...
\subsection{Detector-targeted white-box evasion}
...
This is a white-box feature-level threat model: the search calls the detector's scoring functions directly, and the frozen substitution vocabulary was designed with knowledge of the detector vocabulary. It therefore tests this detector's reformulation sensitivity, not black-box attacker realism or heuristic detectors generally.
